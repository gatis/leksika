...
public class ScoreActivity extends TabActivity {
	...
	public static final String DEFINE_URL = "http://www.tezaurs.lv/#/sv/";
	...
	private void addMissedWord(ViewGroup vg, BuildTrie.Solution solution) {
	...
	private class DefinerListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			Uri u = Uri.parse(DEFINE_URL+word.toLowerCase());
			i.setData(u);
			startActivity(i);
		}
	}
